        ...
        <div class="col-md-6">
            ...
            <div id="row_gameRound" class="row" style="display:none">
                ...
                <div class="col-md-12 middle">
                    <span id="notes" style="color: blue"><b>Note: </b>1. You need to play 5 rounds to complete one game. 2. In each round, you will have up to 10 guesses. 3. The more guesses you have used in one round, the fewer points you will receive. 4. If more than 30 seconds is spent in one round, your points will be deducted as well.</span>
                </div>
                <div class="col-md-12 middle">
